...
// https://github.com/MinecraftForge/MinecraftForge/blob/1.20.1/src/main/java/net/minecraftforge/common/crafting/CraftingHelper.java
...
//            });
//            if (!vanilla.isEmpty())
//                ingredients.add(IngredientHelper.merge(vanilla));
...
//            return new CompoundIngredient(ingredients).toVanilla();
//        }
...
//        IngredientType<?> serializer = NeoForgeRegistries.INGREDIENT_TYPES.get(ResourceLocation.tryParse(type));
//        IIngredientSerializer<?> serializer = ingredients.get(ResourceLocation.tryParse(type));
//        if (serializer == null)
...
//    }
    ...
    public static ItemStack getItemStack(JsonObject json, boolean readNBT, boolean disallowsAirInRecipe) {
        ...
        if (readNBT && json.has("nbt")) {
            ...
            ItemStack itemStack = new ItemStack(item, GsonHelper.getAsInt(json, "count", 1));
            itemStack.set(ModComponents.CUSTOM_DATA, CustomData.of(nbt));
            return itemStack;
        }
