...
public class BulletHoleOption implements ParticleOptions {
    public static final MapCodec<BulletHoleOption> MAP_CODEC = RecordCodecBuilder.mapCodec(builder ->
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, BulletHoleOption> STREAM_CODEC = StreamCodec.composite(
            ByteBufCodecs.VAR_INT, po -> po.getDirection().ordinal(),
            ByteBufCodecs.VAR_LONG, po -> po.getPos().asLong(),
