...
public class ModRecipe {
    ...
    public static DeferredHolder<RecipeSerializer<?>, RecipeSerializer<?>> GUN_SMITH_TABLE_RECIPE_SERIALIZER = RECIPE_SERIALIZERS.register("gun_smith_table_crafting", GunSmithTableSerializer::new);
